import { ChainId, Currency, currencyEquals, JSBI, Price } from '@honorswap/sdk'
...
const BUSD_MAINNET = tokens.busd
...
export default function useBUSDPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [chainId ? WBNB : undefined,  BUSD_MAINNET ],
    ],
...
export const useCakeBusdPrice = (): Price | undefined => {
  ...
  if(cakeBusdPrice)
  {
    ...
    console.log("HNR Price");
    console.log(cakeBusdPrice.toFixed(3))
  }
  ...
  if(bnbBusdPrice)
  {
    ...
    console.log(bnbBusdPrice.toFixed(3))
  }
